...
<main>
    ...
    <?php } ?>
            ...
            <form method="POST" action="">
                ...
                <input type="text" id="name" name="name" pattern="[A-Za-z ]{3,50}" value="<?= $details['name'] ?>" required><br><br>
                <label for="email">Your Email:</label><br>
                <input type="email" id="email" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" value="<?= $details['email'] ?>"><br><br>
